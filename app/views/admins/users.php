...
<!--                                <td>-->
<!--                                    <form method="post"-->
<!--                                          action="--><?php //echo URLROOT; ?><!--/admins/deleteuser/--><?php //echo $user->userid ?><!--">-->
...
<!--                    <a class="page-link"-->
<!--                       href="--><?php //echo URLROOT; ?><!--/admins/--><?php //echo $data['currentPage'] - 1; ?><!--">Previous</a>-->
<!--                </li>-->
<!--                --><?php //for ($i = 1; $i <= $data['totalPages']; $i++): ?>
<!--                    <li class="page-item --><?php //echo ($data['currentPage'] == $i) ? 'active' : ''; ?><!--">-->
<!--                        <a class="page-link"-->
<!--                           href="--><?php //echo URLROOT; ?><!--/admins/--><?php //echo $i; ?><!--">--><?php //echo $i; ?><!--</a>-->
<!--                    </li>-->
<!--                --><?php //endfor; ?>
<!--                <li class="page-item --><?php //echo ($data['currentPage'] == $data['totalPages']) ? 'disabled' : '' ?><!--">-->
<!--                    <a class="page-link"-->
<!--                       href="--><?php //echo URLROOT; ?><!--/admins/--><?php //echo $data['currentPage'] + 1; ?><!--">Next</a>-->
<!--                </li>-->
<!--            </ul>-->
<!--        </nav>-->
<!--    </div>-->
                ...
                <table class="table">
                    ...
                    <?php foreach ($data['users'] as $user): ?>
                        <tr>
                            ...
                            <td>
                                <form method="post"
                                      action="<?php echo URLROOT; ?>/admins/deleteuse/<?php echo $user->userid ?>" onsubmit="checkDelete(event)">
...
<div class="modal fade" id="deleteModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Do you want to delete? This process cannot be undone</div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
